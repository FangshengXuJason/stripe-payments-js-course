      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className='well'>
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1LPUZCEVBJjeleBiVT8navzF' // it's called 'price...' now?
                ? // (plan === 'plan_HC2o83JbeowZnP'// demo
                  'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1LPUZCEVBJjeleBiVT8navzF')}
            // onClick={() => setPlan('plan_HC2o83JbeowZnP')} // demo
          >
            Choose Monthly $25/m
          </button>
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1LPUZCEVBJjeleBiJi06P219'
                ? // (plan === 'plan_HD6rlaovzAiM7B' // demo
                  'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1LPUZCEVBJjeleBiJi06P219')}
            // onClick={() => setPlan('plan_HD6rlaovzAiM7B')} //demo
          >
